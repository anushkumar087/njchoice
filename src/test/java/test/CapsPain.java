...
public class CapsPain extends Base{
	...
	public CapsPain(String dataFile) {
		super(dataFile);
	}
	...
	public void setUp()
	{
		base = new CapsPain(DataFile.CapsPain_DataFile);
	...
	@Test(dataProvider="PainCAP", priority=5)
	void capsPain(String ij5a, String ij5b, String output)
	{	
		Reusables.setIOMapping(IOMapping.getCapsPainInputs(),IOMapping.getCapsPainOutput(),new Object(){}.getClass().getEnclosingMethod().getName());
		...
		Reusables.validateOutput(capsAlgoPage.painValue,output);
		
		njChoicePage.njChoiceAssessmentTab.click();
	}
	
	
	@DataProvider(name="PainCAP")
	public static Object[][] getTestDataCardio() throws IOException
	{
		String[] requiredInputs = IOMapping.getCapsPainInputs();
		String output = IOMapping.getCapsPainOutput();
		Object[][] testData = TestData.getRequiredDataFromMasterSheet(requiredInputs, output, DataFile.CapsPain_DataFile);
		return testData;
