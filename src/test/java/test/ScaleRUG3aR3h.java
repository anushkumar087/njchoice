...
public class ScaleRUG3aR3h extends Base{
	...
	public ScaleRUG3aR3h(String dataFile) {
		super(dataFile);
	}
	...
	public void setUp()
	{
		base = new ScaleRUG3aR3h(DataFile.ScaleRUG3aR3h_DataFile);
	...
	@Test(dataProvider="RUG3aR3hScale", priority=48)
	void scaleRUG3aR3h(String iC1,String iC2a,String iD1,String iE3a,String iE3b,String iE3c,String iE3d,String iE3e,String iE3f,String iG1aa,String iG1da,
	...
	{
		Reusables.setIOMapping(IOMapping.getRUG3aR3hInputs(),IOMapping.getRUG3aR3hOutput(),new Object(){}.getClass().getEnclosingMethod().getName());
		...
		Reusables.validateOutput(capsAlgoPage.rug3aR3hValue,output);
		
		njChoicePage.njChoiceAssessmentTab.click();
	}
	
	
	@DataProvider(name="RUG3aR3hScale")
	public static Object[][] getTestDataRUG3aR3hScale() throws IOException
	{
		String[] requiredInputs = IOMapping.getRUG3aR3hInputs();
		String output = IOMapping.getRUG3aR3hOutput();
		Object[][] testData = TestData.getRequiredDataFromMasterSheet(requiredInputs, output, DataFile.ScaleRUG3aR3h_DataFile);
		return testData;
